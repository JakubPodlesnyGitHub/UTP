...
public class Con1ClientSerwer {
    Connection con;
    DatabaseMetaData md;

   // String driverName = "org.apache.derby.jdbc.ClientDriver";				// nazwa sterownika w trybie clientSerwer
    String url = "jdbc:derby://localhost/ksidb";					// url bazy w trybie clientSerwer

    public Con1ClientSerwer()  {
        try {
